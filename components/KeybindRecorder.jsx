// reference:
// https://github.com/TheShadowGamer/Disconnect-From-Voice/blob/main/components/KeybindRecorder.jsx
// https://github.com/E-boi/Privacy-Tab/blob/master/Components/KeybindRecorder.jsx
...
module.exports = class TextInput extends React.PureComponent {
	...
	render() {
		const className = this.state.recording
			? "powercord-keybind recording pc-container"
			: "powercord-keybind pc-container pc-hasValue";
		return (
								...
								<button type="button" className="powercord-keybind-button pc-button pc-grow">
									<div className="powercord-keybind-button-inner pc-contents">
										<span className="text pc-text">
											{this.state.recording ? "Stop Recording" : "Edit Keybind"}
										</span>
